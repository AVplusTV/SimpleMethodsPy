...
pyautogui.alert (text = 'Переключите раскладку на Английский', title = 'Однажды в студеную зимнюю пору я из лесу вышел...', button = 'OK')

raw_input = input ("Please click any button")
...
class TestMouse(unittest.TestCase):
    ...
    def test_moveToWithTween(self):
        origin = self.center - P(1000, 100)
        destination = self.center + P(100, 500)
